(function () {
  ...
  cw3.addEventListener("click", function () {
    // Fetch posts and comments from my-json-server and render posts with their comments
    fetch('https://my-json-server.typicode.com/Naver510/rag/posts')
      .then(response => response.json())
      .then(posts => {
        fetch('https://my-json-server.typicode.com/Naver510/rag/comments')
          .then(response => response.json())
          .then(comments => {
            const byPost = {}
            comments.forEach(c => {
